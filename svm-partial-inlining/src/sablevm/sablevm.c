...
printVersionAndCopyright (void)
{
  ...
  printf
    ("Copyright (C) 2000-2006 by the copyright holders of SableVM.\n"
     "All rights reserved.\n\n"
     ...
     "\"%s\".\n\n"
     "The SableVM web site is located at http://sablevm.org .\n\n",
     PKGDATADIR);
}
...
printFullVersion (void)
{
  ...
  printf ("- method inlining\n");
#ifdef _SABLEVM_METHOD_INLINING_STATS
  printf ("- method inlining statistics\n");
#endif /* _SABLEVM_METHOD_INLINING_STATS */
...
#define ARG_NO_COPYRIGHT 12
  ...
  if (license)
      ...
      if (exit_status != EXIT_SUCCESS)
	{
      ...
      exit_status = displayFileContent (PKGDATADIR, "AL20", 1);
      ...
      if (exit_status != EXIT_SUCCESS)
	{
      ...
      exit_status = displayFileContent (PKGDATADIR, "NOTICE", 0);
