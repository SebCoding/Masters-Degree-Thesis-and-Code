...
#ifndef _SABLEVM_MEMORY_DEBUGGING

#define _svmm_malloc(size) _svmh_malloc(size)
#define _svmm_calloc(nmemb,size) _svmh_calloc(nmemb,size)
#define _svmm_realloc(ptr,size) _svmh_realloc(ptr,size)
#define _svmm_free(ptr) _svmh_free (ptr)

#else /* _SABLEVM_MEMORY_DEBUGGING */

/* no logging of allocations */
#define _svmm_malloc_ndebug(size) _svmh_malloc_ndebug(size)
#define _svmm_calloc_ndebug(nmemb,size) _svmh_calloc_ndebug(nmemb,size)
/* #define _svmm_realloc_ndebug(ptr,size) _svmh_realloc_ndebug(ptr,size) */
#define _svmm_free_ndebug(ptr) _svmh_free_ndebug(ptr)

/* used for logging all allocations and frees */

#define _svmm_malloc(size) \
_svmh_malloc(__FILE__,__FUNCTION__,__LINE__,size)

#define _svmm_calloc(nmemb,size) \
_svmh_calloc(__FILE__,__FUNCTION__,__LINE__,nmemb,size)

#define _svmm_realloc(ptr,size) \
_svmh_realloc(__FILE__,__FUNCTION__,__LINE__,ptr,size)

#define _svmm_free(ptr) \
_svmh_free (__FILE__,__FUNCTION__,__LINE__,ptr)
