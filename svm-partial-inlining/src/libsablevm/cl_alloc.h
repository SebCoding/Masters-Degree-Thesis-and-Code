...
#define _svmm_cl_zfree_CONSTANT_Class_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_Class_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_Double_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_Double_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_Fieldref_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_Fieldref_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_Float_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_Float_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_Integer_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_Integer_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_InterfaceMethodref_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_InterfaceMethodref_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_Long_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_Long_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_Methodref_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_Methodref_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_NameAndType_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_NameAndType_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_String_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_String_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_CONSTANT_Utf8_info(env, cli, ptr) \
_svmh_cl_zfree_CONSTANT_Utf8_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_Code_attribute(env, cli, ptr) \
_svmh_cl_zfree_Code_attribute (env, cli, &ptr)
...
#define _svmm_cl_zfree_ConstantValue_attribute(env, cli, ptr) \
_svmh_cl_zfree_ConstantValue_attribute (env, cli, &ptr)
...
#define _svmm_cl_zfree_Deprecated_attribute(env, cli, ptr) \
_svmh_cl_zfree_Deprecated_attribute (env, cli, &ptr)
...
#define _svmm_cl_zfree_Exceptions_attribute(env, cli, ptr) \
_svmh_cl_zfree_Exceptions_attribute (env, cli, &ptr)
...
#define _svmm_cl_zfree_InnerClasses_attribute(env, cli, ptr) \
_svmh_cl_zfree_InnerClasses_attribute (env, cli, &ptr)
...
#define _svmm_cl_zfree_LineNumberTable_attribute(env, cli, ptr) \
_svmh_cl_zfree_LineNumberTable_attribute (env, cli, &ptr)
...
#define _svmm_cl_zfree_LocalVariableTable_attribute(env, cli, ptr) \
_svmh_cl_zfree_LocalVariableTable_attribute (env, cli, &ptr)
...
#define _svmm_cl_zfree_SourceFile_attribute(env, cli, ptr) \
_svmh_cl_zfree_SourceFile_attribute (env, cli, &ptr)
...
#define _svmm_cl_zfree_Synthetic_attribute(env, cli, ptr) \
_svmh_cl_zfree_Synthetic_attribute (env, cli, &ptr)
...
#define _svmm_cl_zfree_array_info(env, cli, ptr) \
_svmh_cl_zfree_array_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_class_info(env, cli, ptr) \
_svmh_cl_zfree_class_info (env, cli, &ptr)
...
#define _svmm_cl_zfree_native_cif(env, cli, ptr) \
_svmh_cl_zfree_native_cif (env, cli, &ptr)
...
#define _svmm_cl_zfree_native_library(env, cli, ptr) \
_svmh_cl_zfree_native_library (env, cli, &ptr)
...
#define _svmm_cl_zfree_native_method_data(env, cli, ptr) \
_svmh_cl_zfree_native_method_data (env, cli, &ptr)
...
#define _svmm_cl_zfree_unknown_attribute(env, cli, ptr) \
_svmh_cl_zfree_unknown_attribute (env, cli, &ptr)
...
/*
----------------------------------------------------------------------
_svmm_cl_zalloc_mi_invoke_info
----------------------------------------------------------------------
*/

#define _svmm_cl_zalloc_mi_invoke_info(env, cli, ptr) \
_svmh_cl_zalloc_mi_invoke_info (env, cli, &ptr)

/*
----------------------------------------------------------------------
_svmm_cl_zfree_mi_invoke_info
----------------------------------------------------------------------
*/

#define _svmm_cl_zfree_mi_invoke_info(env, cli, ptr) \
_svmh_cl_zfree_mi_invoke_info (env, cli, &ptr)
...
#define _svmm_cl_mfree_attributes(env, cli, n, ptr) \
_svmh_cl_mfree_attributes (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_chars(env, cli, n, ptr) \
_svmh_cl_mfree_chars (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_classes(env, cli, n, ptr) \
_svmh_cl_mfree_classes (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_constant_pool(env, cli, n, ptr) \
_svmh_cl_mfree_constant_pool (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_inner_classes(env, cli, n, ptr) \
_svmh_cl_mfree_inner_classes (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_native_arg_types(env, cli, n, ptr) \
_svmh_cl_mfree_native_arg_types (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_native_args(env, cli, n, ptr) \
_svmh_cl_mfree_native_args (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_super_classes(env, cli, n, ptr) \
_svmh_cl_mfree_super_classes (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_u8(env, cli, n, ptr) \
_svmh_cl_mfree_u8 (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_code(env, cli, n, ptr) \
_svmh_cl_mfree_code (env, cli, n, &ptr)
...
#define _svmm_cl_mfree_size_t(env, cli, n, ptr) \
_svmh_cl_mfree_size_t (env, cli, n, &ptr)
...
#define _svmm_cl_zmfree_fields(env, cli, n, ptr) \
_svmh_cl_zmfree_fields (env, cli, n, &ptr)
...
#define _svmm_cl_zmfree_methods(env, cli, n, ptr) \
_svmh_cl_zmfree_methods (env, cli, n, &ptr)
...
#define _svmm_cl_zmfree_exception_table(env, cli, n, ptr) \
_svmh_cl_zmfree_exception_table (env, cli, n, &ptr)
...
#define _svmm_cl_zmfree_line_number_table(env, cli, n, ptr) \
_svmh_cl_zmfree_line_number_table (env, cli, n, &ptr)
...
#define _svmm_cl_zmfree_local_variable_table(env, cli, n, ptr) \
_svmh_cl_zmfree_local_variable_table (env, cli, n, &ptr)
...
#define _svmm_cl_zmfree_super_interfaces(env, cli, n, ptr) \
_svmh_cl_zmfree_super_interfaces (env, cli, n, &ptr)
