...
dummy ()
{
  ...
  /* copying method_inlining parameters *[::]/
     ...
     m4svm_property_integer(sablevm.method_inlining.method_profiling_start_threshold, vm->mi_info.method_profiling_start_threshold)
     m4svm_property_integer(sablevm.method_inlining.method_profiling_stop_threshold, vm->mi_info.method_profiling_stop_threshold)
     m4svm_property_integer(sablevm.method_inlining.invoke_inlining_threshold, vm->mi_info.invoke_inlining_threshold)
     m4svm_property_integer(sablevm.method_inlining.max_calling_method_length, vm->mi_info.max_calling_method_length)
     m4svm_property_integer(sablevm.method_inlining.max_callee_method_length, vm->mi_info.max_callee_method_length)
