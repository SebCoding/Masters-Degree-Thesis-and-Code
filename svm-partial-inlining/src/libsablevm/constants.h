...
#define SVM_METHOD_PROFILING_NOT_STARTED 0
#define SVM_METHOD_PROFILING_STARTED     1
#define SVM_METHOD_PROFILING_FINISHED    2
...
#define SVM_INSTRUCTION_INITIAL_INVOKESTATIC 332
#define SVM_INSTRUCTION_INITIAL_INVOKESPECIAL 333
#define SVM_INSTRUCTION_INITIAL_INVOKEVIRTUAL 334
#define SVM_INSTRUCTION_INITIAL_INVOKEINTERFACE 335

#define SVM_INSTRUCTION_COUNTING_INVOKESTATIC 336
#define SVM_INSTRUCTION_COUNTING_INVOKESPECIAL 337
#define SVM_INSTRUCTION_COUNTING_INVOKEVIRTUAL 338
#define SVM_INSTRUCTION_COUNTING_INVOKEINTERFACE 339

#define SVM_INSTRUCTION_INLINED_INVOKESTATIC 340
#define SVM_INSTRUCTION_INLINED_INVOKESPECIAL 341
#define SVM_INSTRUCTION_INLINED_INVOKEVIRTUAL 342
#define SVM_INSTRUCTION_INLINED_INVOKEINTERFACE 343

#define SVM_INSTRUCTION_INLINED_IRETURN 344
#define SVM_INSTRUCTION_INLINED_LRETURN 345
#define SVM_INSTRUCTION_INLINED_FRETURN 346
#define SVM_INSTRUCTION_INLINED_DRETURN 347
#define SVM_INSTRUCTION_INLINED_ARETURN 348
#define SVM_INSTRUCTION_INLINED_RETURN 349

/* these special instructions are used in inlined
   method code to assure that we are still in the
   correct path and if not resume execution in the
   original method code as if no inlined_invoke<x>
   had occured */
#define SVM_INSTRUCTION_INLINED_IFEQ 350
#define SVM_INSTRUCTION_INLINED_IFNE 351
#define SVM_INSTRUCTION_INLINED_IFLT 352
#define SVM_INSTRUCTION_INLINED_IFGE 353
#define SVM_INSTRUCTION_INLINED_IFGT 354
#define SVM_INSTRUCTION_INLINED_IFLE 355
#define SVM_INSTRUCTION_INLINED_IF_ICMPEQ 356
#define SVM_INSTRUCTION_INLINED_IF_ICMPNE 357
#define SVM_INSTRUCTION_INLINED_IF_ICMPLT 358
#define SVM_INSTRUCTION_INLINED_IF_ICMPGE 359
#define SVM_INSTRUCTION_INLINED_IF_ICMPGT 360
#define SVM_INSTRUCTION_INLINED_IF_ICMPLE 361
#define SVM_INSTRUCTION_INLINED_IF_ACMPEQ 362
#define SVM_INSTRUCTION_INLINED_IF_ACMPNE 363
#define SVM_INSTRUCTION_INLINED_IFNULL 364
#define SVM_INSTRUCTION_INLINED_IFNONNULL 365
#define SVM_INSTRUCTION_INLINED_IFEQ_CHECK 366
#define SVM_INSTRUCTION_INLINED_IFNE_CHECK 367
#define SVM_INSTRUCTION_INLINED_IFLT_CHECK 368
#define SVM_INSTRUCTION_INLINED_IFGE_CHECK 369
#define SVM_INSTRUCTION_INLINED_IFGT_CHECK 370
#define SVM_INSTRUCTION_INLINED_IFLE_CHECK 371
#define SVM_INSTRUCTION_INLINED_IF_ICMPEQ_CHECK 372
#define SVM_INSTRUCTION_INLINED_IF_ICMPNE_CHECK 373
#define SVM_INSTRUCTION_INLINED_IF_ICMPLT_CHECK 374
#define SVM_INSTRUCTION_INLINED_IF_ICMPGE_CHECK 375
#define SVM_INSTRUCTION_INLINED_IF_ICMPGT_CHECK 376
#define SVM_INSTRUCTION_INLINED_IF_ICMPLE_CHECK 377
#define SVM_INSTRUCTION_INLINED_IF_ACMPEQ_CHECK 378
#define SVM_INSTRUCTION_INLINED_IF_ACMPNE_CHECK 379
#define SVM_INSTRUCTION_INLINED_IFNULL_CHECK 380
#define SVM_INSTRUCTION_INLINED_IFNONNULL_CHECK 381

#define SVM_INSTRUCTION_INLINED_RET 382
#define SVM_INSTRUCTION_INLINED_JSR 383
#define SVM_INSTRUCTION_INLINED_JSR_CHECK 384
#define SVM_INSTRUCTION_INLINED_GOTO 385
#define SVM_INSTRUCTION_INLINED_GOTO_CHECK 386

#define SVM_INSTRUCTION_INLINED_TABLESWITCH_CASE 387
#define SVM_INSTRUCTION_INLINED_TABLESWITCH_CASE_CHECK 388
#define SVM_INSTRUCTION_INLINED_TABLESWITCH_DEFAULT 389
#define SVM_INSTRUCTION_INLINED_TABLESWITCH_DEFAULT_CHECK 390

#define SVM_INSTRUCTION_INLINED_LOOKUPSWITCH_CASE 391
#define SVM_INSTRUCTION_INLINED_LOOKUPSWITCH_CASE_CHECK 392
#define SVM_INSTRUCTION_INLINED_LOOKUPSWITCH_DEFAULT 393
#define SVM_INSTRUCTION_INLINED_LOOKUPSWITCH_DEFAULT_CHECK 394

#define SVM_INSTRUCTION_PROFILING_IFEQ 395
#define SVM_INSTRUCTION_PROFILING_IFNE 396
#define SVM_INSTRUCTION_PROFILING_IFLT 397
#define SVM_INSTRUCTION_PROFILING_IFGE 398
#define SVM_INSTRUCTION_PROFILING_IFGT 399
#define SVM_INSTRUCTION_PROFILING_IFLE 400
#define SVM_INSTRUCTION_PROFILING_IF_ICMPEQ 401
#define SVM_INSTRUCTION_PROFILING_IF_ICMPNE 402
#define SVM_INSTRUCTION_PROFILING_IF_ICMPLT 403
#define SVM_INSTRUCTION_PROFILING_IF_ICMPGE 404
#define SVM_INSTRUCTION_PROFILING_IF_ICMPGT 405
#define SVM_INSTRUCTION_PROFILING_IF_ICMPLE 406
#define SVM_INSTRUCTION_PROFILING_IF_ACMPEQ 407
#define SVM_INSTRUCTION_PROFILING_IF_ACMPNE 408
#define SVM_INSTRUCTION_PROFILING_IFNULL 409
#define SVM_INSTRUCTION_PROFILING_IFNONNULL 410
#define SVM_INSTRUCTION_PROFILING_IFEQ_CHECK 411
#define SVM_INSTRUCTION_PROFILING_IFNE_CHECK 412
#define SVM_INSTRUCTION_PROFILING_IFLT_CHECK 413
#define SVM_INSTRUCTION_PROFILING_IFGE_CHECK 414
#define SVM_INSTRUCTION_PROFILING_IFGT_CHECK 415
#define SVM_INSTRUCTION_PROFILING_IFLE_CHECK 416
#define SVM_INSTRUCTION_PROFILING_IF_ICMPEQ_CHECK 417
#define SVM_INSTRUCTION_PROFILING_IF_ICMPNE_CHECK 418
#define SVM_INSTRUCTION_PROFILING_IF_ICMPLT_CHECK 419
#define SVM_INSTRUCTION_PROFILING_IF_ICMPGE_CHECK 420
#define SVM_INSTRUCTION_PROFILING_IF_ICMPGT_CHECK 421
#define SVM_INSTRUCTION_PROFILING_IF_ICMPLE_CHECK 422
#define SVM_INSTRUCTION_PROFILING_IF_ACMPEQ_CHECK 423
#define SVM_INSTRUCTION_PROFILING_IF_ACMPNE_CHECK 424
#define SVM_INSTRUCTION_PROFILING_IFNULL_CHECK 425
#define SVM_INSTRUCTION_PROFILING_IFNONNULL_CHECK 426

#define SVM_INSTRUCTION_PROFILING_TABLESWITCH 427
#define SVM_INSTRUCTION_PROFILING_LOOKUPSWITCH 428
#define SVM_INSTRUCTION_PROFILING_TABLESWITCH_CHECK 429
#define SVM_INSTRUCTION_PROFILING_LOOKUPSWITCH_CHECK 430

#define SVM_INSTRUCTION_PROFILING_INVOKESTATIC 431
#define SVM_INSTRUCTION_PROFILING_INVOKESPECIAL 432
#define SVM_INSTRUCTION_PROFILING_INVOKEVIRTUAL 433
#define SVM_INSTRUCTION_PROFILING_INVOKEINTERFACE 434

#ifdef _SABLEVM_INLINED_THREADED_INTERPRETER
 #define SVM_INSTRUCTION_INLINED_JMP_OVER_NEXT_SEQ 435
 #define SVM_INSTRUCTION_COUNT 436
#else
 #define SVM_INSTRUCTION_COUNT 435
#endif
