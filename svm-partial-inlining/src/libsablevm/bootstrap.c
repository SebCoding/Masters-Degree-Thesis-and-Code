...
_svmf_bootstrap (_svmt_JNIEnv *env)
{
  ...
  /* Create, link, and initialize class: java/lang/Throwable */
  if (_svmm_create_class
      (env, vm->class_loading.boot_loader.class_loader_info,
       "java/lang/Throwable", vm->class_loading.boot_loader.classes.jlthrowable) != JNI_OK)
    {
      _svmf_printf (env, stderr,
		    "*** Fatal error: Unable to create essential class java/lang/Throwable.\n");
      return JNI_ERR;
    }

  if (_svmf_link_class
      (env, vm->class_loading.boot_loader.classes.jlthrowable) != JNI_OK)
    {
      _svmf_printf (env, stderr,
		    "*** Fatal error: Unable to link essential class java/lang/Throwable.\n");
      return JNI_ERR;
    }
  ...
  if (_svmf_special_initialization
    ...
    {
      _svmf_printf (env, stderr,
		    "*** Fatal error: Unable to initialize essential class java/lang/Throwable.\n");
      return JNI_ERR;
    }
