...
JNIEXPORT static jclass JNICALL
Java_java_lang_VMClass_getSuperclass (JNIEnv *_env,
				      jclass vmclass SVM_UNUSED,
				      jclass theclass)
{
...
JNIEXPORT static jobjectArray JNICALL
Java_java_lang_VMClass_getInterfaces (JNIEnv *_env,
				      jclass vmclass SVM_UNUSED,
				      jclass theclass)
{
...
JNIEXPORT static jboolean JNICALL
Java_java_lang_VMClass_isInitialized (JNIEnv *_env,
				      jclass vmclass SVM_UNUSED,
				      jclass theclass)
{
  _svmt_JNIEnv *env = _svmf_cast_svmt_JNIEnv (_env);
...
JNIEXPORT static void JNICALL
Java_java_lang_VMClass_throwException (JNIEnv *_env,
