...
#define _svmm_cl_zfree_$1(env, cli, ptr) \
_svmh_cl_zfree_$1 (env, cli, &ptr)
...
#define _svmm_cl_mfree_$1(env, cli, n, ptr) \
_svmh_cl_mfree_$1 (env, cli, n, &ptr)
...
#define _svmm_cl_zmfree_$1(env, cli, n, ptr) \
_svmh_cl_zmfree_$1 (env, cli, n, &ptr)
