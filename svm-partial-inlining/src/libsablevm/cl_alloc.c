...
/*
----------------------------------------------------------------------
_svmh_cl_zalloc_mi_invoke_info
----------------------------------------------------------------------
*/

svm_static jint
_svmh_cl_zalloc_mi_invoke_info (_svmt_JNIEnv *env,
		    _svmt_class_loader_info *class_loader_info, _svmt_mi_invoke_info ** ptr)
{
  return _svmf_cl_zalloc (env, class_loader_info, sizeof (_svmt_mi_invoke_info), (void **) ptr);
}

/*
----------------------------------------------------------------------
_svmh_cl_zfree_mi_invoke_info
----------------------------------------------------------------------
*/

svm_static void SVM_UNUSED
_svmh_cl_zfree_mi_invoke_info (_svmt_JNIEnv *env,
		   _svmt_class_loader_info *class_loader_info, _svmt_mi_invoke_info ** ptr)
{
  _svmf_cl_free (env, class_loader_info, sizeof (_svmt_mi_invoke_info), (void **) ptr);
}
...
_svmh_cl_zmalloc_fields (_svmt_JNIEnv *env,
		     _svmt_class_loader_info *class_loader_info,
		     size_t nmemb, _svmt_field_info ** ptr)
{
...
_svmh_cl_zmalloc_methods (_svmt_JNIEnv *env,
		     _svmt_class_loader_info *class_loader_info,
		     size_t nmemb, _svmt_method_info ** ptr)
{
...
_svmh_cl_zmalloc_exception_table (_svmt_JNIEnv *env,
		     _svmt_class_loader_info *class_loader_info,
		     size_t nmemb, _svmt_exception_table ** ptr)
{
...
_svmh_cl_zmalloc_line_number_table (_svmt_JNIEnv *env,
		     _svmt_class_loader_info *class_loader_info,
		     size_t nmemb, _svmt_line_number_table ** ptr)
{
...
_svmh_cl_zmalloc_local_variable_table (_svmt_JNIEnv *env,
		     _svmt_class_loader_info *class_loader_info,
		     size_t nmemb, _svmt_local_variable_table ** ptr)
{
